  ...
  try {
    ...
    const table = `
      <div>
        ...
        <a target="_blank" href="${process.env.NEXTAUTH_URL}" style="color: #007bff; text-decoration: none; font-weight: bold; cursor:pointer;">برای ورود به وبسایت اینجا کلیک کنید</a>
      </div>
